...
public interface MethodConstants {
    ...
    String startSpecificActivity = "startSpecificActivity";
    String realStartActivityLocked = "realStartActivityLocked";
    String resumeTopActivityInnerLocked = "resumeTopActivityInnerLocked";
    String sendSignal = "sendSignal";
    String sendSignalQuiet = "sendSignalQuiet";
